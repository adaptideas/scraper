[chapter Real World Examples for The Lazy]
...
[section Ignoring the end point]
...
[section Attribute To determine begin point]

[code]
<img src="/img/gif/cx_seta_local_site.gif">${name}</span>
[/code]

[section Problems with encoding]
...
[section Too Lazy to get the tag structure]
...
[section Adding tags that are on the template]
